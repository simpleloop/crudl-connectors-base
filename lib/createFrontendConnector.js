...
function completeConnector(full, partial = {}) {
...
module.exports = function createFrontendConnector(connector) {
  const c = completeConnector(defaultConnector, connector);
  ...
  fc.use = mw => createFrontendConnector(completeConnector(fc, mw(c)));
